...
<body>
	...
	<header style="width:100%; height:70px; /*background:rgba(0,181,173,0.8);*/ background:rgba(81,98,111,1); ">
		<p style="font-size:20px; font-weight:600; margin:0 0 0 100px; float:left; color:#fff; line-height:70px;"/><span style="color:#A31432; color:#fff; font-size:30px">DOCKER2EDU_</span><span style="color:#A31432; color:#fff; font-size:20px">PROFESSOR</span>
					...
					<div class="ui stacked segment">
						<div class="field">
							<div class="ui left icon input">
								<i class="user icon"></i>
								<input style="color:rgba(81,98,111,1);" type="username" name="username" id="name" placeholder="수업 이름 ">
							</div>
							     <div class="ui left icon input">
                                                                <i class="user icon"></i>
                                                                <input style="color:rgba(81,98,111,1);" type="username" name="class_sub" id="sub" placeholder="분반 번호">
                                                        </div>

							<div class="ui left icon input">
								<i class="lock icon"></i>
								<input style="color:rgba(81,98,111,1);" type="username" name="pro_name" id="pro" placeholder="교수님 이름">
							</div>
                                                        <div class="ui left icon input">
                                                                <i class="lock icon"></i>
                                                                <input style="color:rgba(81,98,111,1);" type="username" name="start_time" id="stime" placeholder="시작 시간">
                                                        </div>

							  <div class="ui left icon input">
                                                                <i class="user icon"></i>
                                                                <input style="color:rgba(81,98,111,1);" type="username" name="end_time" id="etime" placeholder="종료 시간">
                                                        </div>
							  <div class="ui left icon input">
                                                                <i class="user icon"></i>
                                                                <input style="color:rgba(81,98,111,1);" type="username" name="end_time" id="etime" placeholder="수업 요일">
                                                        </div>
...
<article  class="footer-box" style="width:750px; margin:-175px 0 0 -375px; height:70px; bottom:0; margin:-175px 0 0 -375px;  position:absolute; left:50%;">
	<article style=" width:100%; padding-bottom: 50px;">
		<div>
			<img src="../static/img/support1.png"  />
			<img style="padding-left: 15px;" src="../static/img/support3.png" />
			<img src="../static/img/support2.png" />
		</div>
		<div style="text-align: center; width: 100%;">
			</br>
			</br>
			<p style=" color: #888;">Copyright &copy; 2016 Team IU (SSG). All rights reserved.</p>
		</div>
	</article>
</article>
